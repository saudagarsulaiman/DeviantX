package com.cryptowallet.trendchart;
...
public class ChartView extends View {
  ...
  //纬线数量
  private final int LATITUDE_NUM = 0;
  //经线数量
  private final int LONGITUDE_NUM = 0;

  private Paint mBorderPaint;
  private Paint mLinePaint;

  protected Quadrant mQuadrant = new Quadrant(dp2px(0), dp2px(0), dp2px(0), dp2px(0)) {
    @Override
    ...
    public float getQuadrantWidth() {
      return getMeasuredWidth() - dp2px(0) * 0;
    }

    @Override
    public float getQuadrantHeight() {
      return getMeasuredHeight() - dp2px(0) * 0;
    }
  };
