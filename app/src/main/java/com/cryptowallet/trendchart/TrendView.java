...
public class TrendView extends ChartView {
    ...
    protected void setupPaint() {
        ...
        mAreaPaint.setColor(Color.YELLOW);
   ...
   /* canvas.drawLine(mCurrentX, mQuadrant.getQuadrantStartY(), mCurrentX,
    ...
    public void setBorderandFillColor(int borderColor, int fillColor) {
        mTrendLinePaint.setColor(borderColor);
        mAreaPaint.setColor(fillColor);
    }
