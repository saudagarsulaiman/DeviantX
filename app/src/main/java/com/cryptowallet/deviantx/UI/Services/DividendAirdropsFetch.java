...
public class DividendAirdropsFetch extends IntentService {
    /**
    ...
    DividendAirdropsUIListener dividendAirdropsUIListener;
    DeviantXDB deviantXDB;

    public DividendAirdropsFetch() {
        super("DividendAirdropsFetch");
    }
...
//            startForeground(NOTIFICATION_ID, new Notification.Builder(this).build());
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        fetchDividendAirdrops();
    }

    private void fetchDividendAirdrops() {
        try {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    try {
                        ...
                        if (!responsevalue.isEmpty() && responsevalue != null) {
                            ...
                            dividendAirdropsUIListener = myApplication.getDividendAirdropsUIListener();
                            if (dividendAirdropsUIListener != null) {
                                dividendAirdropsUIListener.onChangedDividendAirdrops(responsevalue);
                            }
