...
public class FeaturedAirdropsFetch extends IntentService {
    /**
    ...
    FeaturedAirdropsUIListener featuredAirdropsUIListener;
    DeviantXDB deviantXDB;

    public FeaturedAirdropsFetch() {
        super("FeaturedAirdropsFetch");
    }
...
//            startForeground(NOTIFICATION_ID, new Notification.Builder(this).build());
    ...
    private void fetchFeaturedAirdrops() {
        try {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    try {
                        ...
                        if (!responsevalue.isEmpty() && responsevalue != null) {
                            ...
                            featuredAirdropsUIListener = myApplication.getFeaturedAirdropsUIListener();
                            if (featuredAirdropsUIListener != null) {
                                featuredAirdropsUIListener.onChangedFeaturedAirdrops(responsevalue);
                            }
