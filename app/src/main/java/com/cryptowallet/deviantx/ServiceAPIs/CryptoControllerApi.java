...
public interface CryptoControllerApi {
    ...
    @GET("/api/v2/crypto/deposit_wallet/{coin_code}/{wallet_name}")
    ...
    @GET("/api/v2/crypto/deposit_wallet_transaction_using_wallet/{wallet_name}/{coin_code}")
...
*/
    ...
    @GET("/api/v2/crypto/update_fav/{id}/{state}")
