...
public interface UserControllerApi {
    ...
    @GET("/api/v2/account/disable_2fa/{password}/{totp}")
    ...
    @GET("/api/v2/account/enable_2fa/{password}/{totp}")
    ...
    @GET("/api/v2/account/generate_2fa/{password}/{secret}/{totp}")
...
//    Call<ResponseBody> get2FAStatus(@Header("Authorization") String AuthorizationDX);
    ...
    @GET("/api/v2/account/verify_2fa/{totp}")
