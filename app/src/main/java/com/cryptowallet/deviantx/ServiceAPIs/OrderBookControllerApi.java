...
public interface OrderBookControllerApi {
    ...
    */
    ...
    @POST("/api_v2/order_book/get/all")
    Call<ResponseBody> getAll(@Header("Authorization") String AuthorizationDX, @Body String body);
    ...
    */
    @Headers("Content-Type: application/json")
    @POST("/api_v2/order_book/get/all/open_pending")
    Call<ResponseBody> getAllOpen(@Header("Authorization") String AuthorizationDX, @Body String body);
